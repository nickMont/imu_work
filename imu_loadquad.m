...
N0=length(thist0);
%N0=3;
xhist_init=ewxv0(7:9,2:end)';
ehist_init=ewxv0(1:3,2:end)';

% % Lab loaded from test.mat
%Lab_true=[1;0.5;0.2];
...
%    [state,Pk,RBI,Limu]=runEKF(imuMeasStore{ij},gpsMeasStore{ij},state0,RBI,P0,systemParams);
