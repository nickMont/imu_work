...
xpMat(:,1) = f_imu_dyn(dt,xhat_aug(1:nx),RBI0,fB,wB,xhat_aug(nx+1:end),tauA,tauG,L0);
...
for ij=1:2*(nx+nv)
    ...
    xpMat(:,ij+1) = f_imu_dyn(dt,xaug_ij(1:nx),RBI0,fB,wB,xaug_ij(nx+1:end),tauA,tauG,L0);
